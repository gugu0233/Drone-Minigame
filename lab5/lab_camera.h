...
namespace implemented
{
    ...
    public:
        ...
        glm::vec3 CalculateMoveForward(float distance)
        {
            glm::vec3 dir = glm::normalize(glm::vec3(forward.x, 0, forward.z));
            return dir * distance;
        }
        ...
        void TranslateUpward(float distance)
        {
            ...
            glm::vec3 upDirection = glm::normalize(glm::vec3(0, 1, 0));
            position += upDirection * distance;
        }

        glm::vec3 CalculateTranslateUpward(float distance)
        {
            // Translate the camera using the up vector.
            glm::vec3 upDirection = glm::normalize(glm::vec3(0, 1, 0));
            return upDirection * distance;
        }
        ...
        glm::vec3 CalculateTranslateRight(float distance)
        {
            glm::vec3 dir = glm::normalize(glm::vec3(right.x, 0, right.z));
            return dir * distance;
        }
